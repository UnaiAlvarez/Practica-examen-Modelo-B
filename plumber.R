...
#* @get banco_mas_antiguo
#* @param localizacion
#* @apiTitle Que banco de alimentos es el mas antiguo?

 

banco_de_alimentos <- function(localizacion) {
  url <- paste0("https://www.givefood.org.uk/api/2/foodbank/", localizacion ,"/")
  request <- GET(url)
  ...
  list(paste0("el banco de alimentos mas antiguo es ",Name, " creado en ",Fecha, "y sus necesidades son : ",necesidades))
}
